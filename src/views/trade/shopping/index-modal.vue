<template>
  <a-drawer title="消费详情" :width="600" :open="visible" :body-style="{ paddingBottom: '80px' }" @close="onClose">
    <a-card style="margin-bottom: 15px" size="small">
      <a-descriptions :column="2" size="small">
        ...
        <a-descriptions-item label="消费金额">{{ chatUser.amount }}</a-descriptions-item>
        <a-descriptions-item label="消费日期">{{ chatUser.createTime }}</a-descriptions-item>
...
async function queryTradeInfo(tradeId) {

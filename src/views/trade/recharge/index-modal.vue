<template>
  <a-drawer title="充值详情" :width="600" :open="visible" :body-style="{ paddingBottom: '80px' }" @close="onClose">
    <a-card style="margin-bottom: 15px" size="small">
      ...
      <a-descriptions :column="2" size="small">
        <a-descriptions-item label="支付方式">{{ chatUser.payTypeLabel }}</a-descriptions-item>
        <a-descriptions-item label="充值金额">{{ chatUser.amount }}</a-descriptions-item>
      ...
      <a-descriptions :column="1" size="small">
        <a-descriptions-item label="商户单号">{{ chatUser.orderNo }}</a-descriptions-item>

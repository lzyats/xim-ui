<template>
  <a-form class="smart-query-form">
    <a-row class="smart-query-form-row">
      ...
      <a-form-item label="发送手机号码" class="smart-query-form-item">
        <a-input style="width: 150px" v-model:value="queryForm.phone" :maxlength="11" placeholder="发送手机号码"
          :allowClear=true />
      </a-form-item>
    ...
    <a-row class="smart-query-form-row" v-show="moreQueryConditionFlag">
      <a-form-item label="领取用户编号" class="smart-query-form-item">
        <a-input style="width: 150px" v-model:value="queryForm.receiveNo" placeholder="领取用户编号" :allowClear=true />
      </a-form-item>
      <a-form-item label="领取手机号码" class="smart-query-form-item">
        <a-input style="width: 150px" v-model:value="queryForm.receivePhone" :maxlength="11" placeholder="领取手机号码"
          :allowClear=true />
      </a-form-item>
    </a-row>
  </a-form>
  ...
  <a-card size="small" :bordered="false" :hoverable="true">
    ...
    <a-row class="smart-table-btn-block">
      ...
      <div class="smart-table-setting-block">
        <TableOperator v-model="columns" :tableId="TABLE_ID.AU" :refresh="queryList" />
      </div>
    </a-row>
    <!---------- 表格操作行 end ----------->
  ...
  <PacketRef ref="packetRef" @reloadList="queryList" />
</template>
<script setup>
import { onMounted, reactive, ref } from 'vue';
import PacketRef from './index-modal.vue';
...
function handView(tradeId) {
  packetRef.value.showModal(tradeId);
}

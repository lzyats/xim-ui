<template>
  ...
  <a-card size="small" :bordered="false" :hoverable="true">
    ...
    <a-row class="smart-table-btn-block">
      ...
      <div class="smart-table-setting-block">
        <TableOperator v-model="columns" :tableId="TABLE_ID.AX" :refresh="queryList" />
      </div>
    </a-row>
    <!---------- 表格操作行 end ----------->
  ...
  <NormalRef ref="normalRef" @reloadList="queryList" />

</template>
<script setup>
import { onMounted, reactive, ref } from 'vue';
import NormalRef from './index-modal.vue';
...
function handView(tradeId) {
  normalRef.value.showModal(tradeId);
}

  ...
  <a-card size="small" :bordered="false" :hoverable="true">
    ...
    <a-row class="smart-table-btn-block">
      ...
      <div class="smart-table-setting-block">
        <TableOperator v-model="columns" :tableId="TABLE_ID.BQ" :refresh="queryList" />
      </div>
    </a-row>
    <!---------- 表格操作行 end ----------->
...
import { shoppingApi } from '/@/api/statistics/shopping-api';
...
async function queryList() {
  ...
  try {
    let queryResult = await shoppingApi.queryList(queryForm);

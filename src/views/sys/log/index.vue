  ...
  <a-card size="small" :bordered="false" :hoverable="true">
    ...
    <a-row class="smart-table-btn-block">
      ...
      <div class="smart-table-setting-block">
        <TableOperator v-model="columns" :tableId="TABLE_ID.AB" :refresh="queryList" />
      </div>
    </a-row>
    <!---------- 表格操作行 end ----------->
    ...
    <a-table size="small" :dataSource="tableData" :columns="columns" rowKey="logId" bordered :pagination="false"
      ...
      <template #bodyCell="{ record, column, index }">
        ...
        <template v-if="column.dataIndex === 'message'">
          {{ record.requestMethod }}<br />{{ record.requestUrl }}<br />
          {{ record.requestParam }}<br />{{ record.message }}
        </template>
        ...
        <template v-if="column.dataIndex === 'action'">
          <div class="smart-table-operate" v-privilege="'sys:log:remove'">
...
import { logApi } from '/@/api/sys/log-api';

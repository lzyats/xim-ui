...
import { portraitUserApi } from '/@/api/operate/portrait-user-api';
...
async function queryList() {
  ...
  try {
    let queryResult = await portraitUserApi.queryPortraitList(queryForm);
...
async function deleteHelp(id) {
  try {
    tableLoading.value = true;
    await portraitUserApi.portraituserDelete(id);

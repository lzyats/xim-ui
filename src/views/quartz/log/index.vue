  ...
  <a-form class="smart-query-form">
    <a-row class="smart-query-form-row">
      <a-form-item label="任务名称" class="smart-query-form-item">
        <a-input style="width: 150px" v-model:value="queryForm.jobName" placeholder="请输入任务名称" :allowClear=true />
      </a-form-item>
  ...
  <a-card size="small" :bordered="false" :hoverable="true">
    ...
    <a-row class="smart-table-btn-block">
      ...
      <div class="smart-table-setting-block">
        <TableOperator v-model="columns" :tableId="TABLE_ID.AD" :refresh="queryList" />
      </div>
    </a-row>
    <!---------- 表格操作行 end ----------->
    ...
    <a-table size="small" :dataSource="tableData" :columns="columns" rowKey="logId" bordered :pagination="false"
      ...
      <template #bodyCell="{ record, column, index }">
        ...
        <template v-if="column.dataIndex === 'action'">
          <div class="smart-table-operate" v-privilege="'quartz:log:remove'">
...
import { logApi } from '/@/api/quartz/log-api';

...
import { HOME_PAGE_NAME, USER_PAGE_PATH, GROUP_PAGE_PATH } from '/@/constants/sys/home-const';
...
function selectTab(name) {
  ...
  if ('用户详情' == tag.menuTitle) {
    router.push(USER_PAGE_PATH + tag.menuName);
    return;
  }
  if ('群组详情' == tag.menuTitle) {
    router.push(GROUP_PAGE_PATH + tag.menuName);
    return;
  }
